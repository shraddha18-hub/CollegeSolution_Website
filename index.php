...
<div>  
             ...
             <img src="picture\DOTtop-header.png" width="1000" height="100" style="display: block;margin-left:auto;margin-right:auto">
          
			</div>
			<marquee direction="left">
<h2> Welcome To College Solution ! ! Score More with College Solution . . . . . !<h2>
</marquee>
		...
		<div class="row m-5 pt-5">
			<div class="col-md-7">
				...
				<table  cellspacing="20" cellpadding="40" width="100%">
					<tr>
						<th>
							<center><h5>One way stop for notes and more</h5></center>
						</th>
					</tr>
					...
					<tr>
						<table class="mt-5" cellpadding="5"	 width="100%">
							<tr>
								<th  width="100">
								<a href="ExamPaper.php">Previous Year Question Papers</a>
								</th>
								<th  width="100">
